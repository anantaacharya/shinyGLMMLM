...
model1<-c("PC","Q")
    ...
    m2<-masterglmmlm.test[masterglmmlm.test$Trait%in% tr1 & masterglmmlm.test$GLMMLM %in% gl1 & masterglmmlm.test$model %in% model1 & masterglmmlm.test$df %in% df1,,drop=FALSE]
